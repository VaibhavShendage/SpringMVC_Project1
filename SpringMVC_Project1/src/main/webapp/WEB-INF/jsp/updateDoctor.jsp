...
<body>
  ...
  <form action="UpdateDr" method="post">
                  ...
                  <h2 style="color:green;text-align: centre;">Update Doctor</h2>
                   ...
                   <label>FirstName:</label>
                    ...
                    <input type="text"  name="specialization" value="${param.specialization }" /><br><br>
                    
                    <label for="gender">Select gender:</label>
				        <select  name="gender" value="${param.gender }">
                    ...
                    <input type="date"  name="dob" value="${param.dob }" /><br><br>
